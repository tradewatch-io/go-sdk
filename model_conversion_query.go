...
// checks if the ConversionQuery type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ConversionQuery{}

// ConversionQuery struct for ConversionQuery
...
type _ConversionQuery ConversionQuery
...
func NewConversionQuery(from string, to string) *ConversionQuery {
	this := ConversionQuery{}
	this.From = from
	this.To = to
	var amount float32 = 10
	this.Amount = &amount
	var precision int32 = 5
...
func (o ConversionQuery) MarshalJSON() ([]byte, error) {
...
func (o ConversionQuery) ToMap() (map[string]interface{}, error) {
...
func (o *ConversionQuery) UnmarshalJSON(data []byte) (err error) {
	...
	varConversionQuery := _ConversionQuery{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varConversionQuery)

	if err != nil {
		return err
	}

	*o = ConversionQuery(varConversionQuery)

	return err
}

type NullableConversionQuery struct {
	value *ConversionQuery
	isSet bool
}

func (v NullableConversionQuery) Get() *ConversionQuery {
	return v.value
}

func (v *NullableConversionQuery) Set(val *ConversionQuery) {
	v.value = val
	v.isSet = true
}

func (v NullableConversionQuery) IsSet() bool {
	return v.isSet
}

func (v *NullableConversionQuery) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableConversionQuery(val *ConversionQuery) *NullableConversionQuery {
	return &NullableConversionQuery{value: val, isSet: true}
}

func (v NullableConversionQuery) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableConversionQuery) UnmarshalJSON(src []byte) error {
	v.isSet = true
