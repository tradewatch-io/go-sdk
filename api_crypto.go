...
func (r ApigetExchangesRequest) Execute() (*CryptoExchangesList, *http.Response, error) {
	return r.ApiService.getExchangesExecute(r)
}

/*
getExchanges Available Exchanges
...
*/
func (a *CryptoAPIService) getExchanges(ctx context.Context) ApigetExchangesRequest {
	return ApigetExchangesRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *CryptoAPIService) getExchangesExecute(r ApigetExchangesRequest) (*CryptoExchangesList, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "CryptoAPIService.getExchanges")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
