...
type ApiCryptoGetExchangesRequest struct {
	ctx context.Context
	ApiService *CryptoAPIService
}

func (r ApiCryptoGetExchangesRequest) Execute() (*CryptoExchangesList, *http.Response, error) {
	return r.ApiService.CryptoGetExchangesExecute(r)
}

/*
CryptoGetExchanges Available Exchanges

Get list of available cryptocurrency exchanges

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiCryptoGetExchangesRequest
*/
func (a *CryptoAPIService) CryptoGetExchanges(ctx context.Context) ApiCryptoGetExchangesRequest {
	return ApiCryptoGetExchangesRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *CryptoAPIService) CryptoGetExchangesExecute(r ApiCryptoGetExchangesRequest) (*CryptoExchangesList, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *CryptoExchangesList
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "CryptoAPIService.CryptoGetExchanges")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/crypto/exchanges"
