...
*/
func (a *CommoditiesAPIService) getQuote(ctx context.Context, symbol string) ApigetQuoteRequest {
	return ApigetQuoteRequest{
		ApiService: a,
		ctx: ctx,
		symbol: symbol,
...
//  @return LastQuote
func (a *CommoditiesAPIService) getQuoteExecute(r ApigetQuoteRequest) (*LastQuote, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "CommoditiesAPIService.getQuote")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/commodities/symbols/{symbol}"
...
func (r ApigetSymbolsRequest) Type_(type_ CommodityType) ApigetSymbolsRequest {
	r.type_ = &type_
	return r
}
...
*/
func (a *CommoditiesAPIService) getSymbols(ctx context.Context) ApigetSymbolsRequest {
	return ApigetSymbolsRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *CommoditiesAPIService) getSymbolsExecute(r ApigetSymbolsRequest) (*CursorPageTCustomizedSymbolsOutFull, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "CommoditiesAPIService.getSymbols")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/commodities/symbols"
...
func (r ApigetTypesRequest) Execute() (*CommodityTypesList, *http.Response, error) {
	return r.ApiService.getTypesExecute(r)
}

/*
getTypes Available Types
...
*/
func (a *CommoditiesAPIService) getTypes(ctx context.Context) ApigetTypesRequest {
	return ApigetTypesRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *CommoditiesAPIService) getTypesExecute(r ApigetTypesRequest) (*CommodityTypesList, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *CommodityTypesList
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "CommoditiesAPIService.getTypes")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/commodities/types"
