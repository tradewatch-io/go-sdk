...
// IndicesAPIService IndicesAPI service
type IndicesAPIService service
...
*/
func (a *IndicesAPIService) getQuote(ctx context.Context, symbol string) ApigetQuoteRequest {
	return ApigetQuoteRequest{
		ApiService: a,
		ctx: ctx,
		symbol: symbol,
...
//  @return LastQuote
func (a *IndicesAPIService) getQuoteExecute(r ApigetQuoteRequest) (*LastQuote, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "IndicesAPIService.getQuote")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/indices/symbols/{symbol}"
...
*/
func (a *IndicesAPIService) getSymbols(ctx context.Context) ApigetSymbolsRequest {
	return ApigetSymbolsRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *IndicesAPIService) getSymbolsExecute(r ApigetSymbolsRequest) (*CursorPageTCustomizedSymbolsOutFull, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "IndicesAPIService.getSymbols")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/indices/symbols"
